...
urlpatterns = [ 
    ...
    path('item/<str:pk>/item_multiple_sales', views.multiple_item_sales, name='update_multiple_sales'),
    path('login/', views.login_user, name='login'),
    path('logout/', views.logout_user, name='logout'),
    path('sales/', views.view_sales, name='view_sales'),
    path('sales/all_sales', views.view_all_sales, name='view_all_sales'),
